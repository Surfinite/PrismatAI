...
test('renderReport includes regret and divergence sections', () => {
  const md = renderReport({
    ...
    perUnitDivergence: [{ internal: 'Hotel', hp: 4, charge: 0, lifespan: -1, aiOnly: 3, humanOnly: 12, examplesAi: [{ replay: 'AAA', step: 42, turn: 5 }], examplesHuman: [{ replay: 'BBB', step: 60, turn: 7 }] }],
  ...
  assert.match(md, /AAA@s42/);                   // citation uses the begin-of-defense STEP
